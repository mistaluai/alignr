...
function ArchitecturePlanReview({
  plan,
  summaryOfChanges,
  version,
  onModify,
...
export function ChatInterface({ projectId, currentStage, onBriefUpdate, onStageAdvance }: ChatInterfaceProps) {
  ...
  // Extract latest architecture plan from messages for dedicated plan review panel
  ...
  // Count architecture plan versions for version display
  ...
  // Whether to show the dedicated plan review panel (replaces chat for architecture stage)
